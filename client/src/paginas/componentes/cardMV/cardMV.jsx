...
const Card = memo(({ title, content, Icon }) => {
  const [isFlipped, setIsFlipped] = useState(false);

  return (
    <div 
      className="flip-card w-full md:w-1/2 p-4 cursor-pointer"
    ...
    >
      <div className={`flip-card-inner ${isFlipped ? 'is-flipped' : ''}`}>
        ...
        <div className="flip-card-back bg-blue-600 text-white p-6 rounded-lg shadow-lg text-center">
